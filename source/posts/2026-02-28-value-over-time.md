...
relative attention to building high-quality things and moving fast.

![An imagined "quality vs. speed" spectrum](/images/quality-vs-speed-score.png)
...
![To a perfectionist mindset, all that matters is average quality](/images/perfectionism.png)
...
proactiveness---delivering more than strictly what was asked---and a
...
![To a "quantity over quality" mindset, average quality doesn't matter](/images/quantity-over-quality.png)
...
If we plot what these two approaches would look like over time, we would
see something like this:

![What the two approaches look like over time](/images/quality-vs-speed-extremes.png)
...
![Two very bad solutions to bivariate optimization](/images/length-vs-width.png)
...
thing we want to optimize for---the area---is a function of both of
those factors. They need to play together.
...
![An imagined "length vs. width" spectrum](/images/length-vs-width-score.png)
...
quality actually _can_ be "more important", not objectively, but
relative to the current state of things.
...
If we have a destination, we need to know both: (a) are we heading the
...
us a long time to get there---possibly so long that the destination
...
A lot of intelligent, hard-working people prioritize quality over speed
...
Sadly, the people who _most_ need to unlearn this lesson are the A
students! They are the ones who "won" in school by focusing solely on
quality (i.e. getting the best possible grade).
